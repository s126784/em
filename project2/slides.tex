...
\begin{frame}{Detailed Method Comparison}
    \begin{table}
        ...
        \begin{tabular}{lccccc}
            \hline
            \textbf{Method} & \textbf{Deviance} & \textbf{Error} & \textbf{Time} & \textbf{Memory} \\
            \hline
            Original & 73.95\% & 0.01862 & - & - \\
            Mean & 72.21\% & 0.02086 & Fast & Low \\
            Median & 72.56\% & 0.02084 & Fast & Low \\
            KNN & 74.09\% & 0.01858 & Medium & Medium \\
            EM & 73.48\% & 0.01879 & Slow & High \\
            Filtered & 73.99\% & 0.02558 & Fast & Low \\
            \hline
        \end{tabular}
    \end{table}
\end{frame}
